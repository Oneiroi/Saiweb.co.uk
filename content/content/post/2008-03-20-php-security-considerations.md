...
$result = mysql_query($sql);{{< / highlight >}}
...
</span><span style="color: #0000bb;">mysql_query</span><span style="color: #007700;">(</span><span style="color: #0000bb;">$query</span><span style="color: #007700;">);</span></span>{{< / highlight >}}{{< highlight bash >}}<span style="color: #000000;"><span style="color: #007700;"> </span><span style="color: #ff8000;">// We didn't check $_POST['password'], it could be anything the user wanted! For example:
...
</span><span style="color: #0000bb;">?&gt;</span></span>{{< / highlight >}}
<p class="example-contents">The query sent to MySQL:</p>

{{< highlight bash >}}
{{< highlight bash >}}SELECT * FROM users WHERE user='aidan' AND password='' OR ''=''{{< / highlight >}}
{{< / highlight >}}
